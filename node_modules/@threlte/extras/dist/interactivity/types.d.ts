...
export declare type FilterFunction = (items: THREE.Intersection[], state: State) => THREE.Intersection[];
export declare type ComputeFunction = (event: DomEvent, state: State) => void;
...
export declare type ThrelteEvents = {
