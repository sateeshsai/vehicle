 ...
 */
export declare type OmittedPropKeys = 'type' | 'args' | 'attach' | 'manual' | 'makeDefault' | 'id' | 'children' | `is${string}` | 'parent' | 'uuid' | 'name';
 ...
 * ### Base Props
 */
export declare type BaseProps<Type extends any> = {
    attach?: string | ((parent: any, self: MaybeInstance<Type>) => (() => void) | void);
};
/**
 * ### Disposable Props
 */
export declare type DisposableProps = {
    /**
 ...
 * ### Class Props
 */
export declare type ClassProps<Type extends any> = Type extends AnyClass ? {
    args?: any[] | ConstructorParameters<Type>;
} : Record<string, unknown>;
export declare type RefProps<Type extends any> = {
    ref?: MaybeInstance<Type>;
};
/**
 * ### Camera Props
 */
export declare type CameraProps<Type extends any> = MaybeInstance<Type> extends {
    isCamera: true;
} ? {
    /**
 ...
 */
export declare type InstanceProps<Type extends any> = Partial<Omit<MaybeInstance<Type> extends Primitive ? Record<string, unknown> : {
 ...
 */
export declare type ObjectEvents<Type extends any> = MaybeInstance<Type> extends {
...
export declare type CreateEvent<Type extends any> = {
    create: {
        ref: MaybeInstance<Type>;
 ...
 */
export declare type Events<Type extends any> = Record<string, any> & CreateEvent<Type> & ObjectEvents<Type>;
