declare type Dispatcher<EventMap extends Record<string, unknown>> = <Type extends keyof EventMap>(type: Type, payload?: EventMap[Type]) => void;
declare type HasEventListener<EventMap extends Record<string, unknown>> = <Type extends keyof EventMap>(type: Type) => boolean;
declare type RawEventDispatcher<EventMap extends Record<string, unknown>> = Dispatcher<EventMap> & {
