...
declare type CleanupFn = () => MaybePromise<void>;
declare type CallbackFn<T> = (values: T) => MaybePromise<void | CleanupFn>;
/**
 * ### `watch`
 *
...
export declare type CurrentWritable<T = unknown> = Writable<T> & {
    current: T;
};
/**
 * ### `currentWritable`
