...
// node_modules/@threlte/core/dist/components/T/utils/resolve.js
...
var useProps = () => {
  ...
  const setProp = (instance6, propertyPath, value, options) => {
    ...
    const { key, target } = resolve(instance6, propertyPath);
...
function instance4($$self, $$props, $$invalidate) {
  ...
  const maybeSetRef = () => {
    ...
    $$invalidate(1, ref = isClass(is) && argsIsConstructorParameters(args) ? new is(...args) : isClass(is) ? new is() : is);
    createEvent.updateRef(ref);
  };
...
// node_modules/@threlte/core/dist/lib/useFrameloop.js
var runUseFrameCallbacks = (ctx, internalCtx, delta) => {
  ...
  if (anyHasOrder) {
    Array.from(internalCtx.allFrameHandlers).sort((a, b) => (a.order ?? 0) > (b.order ?? 0) ? 1 : -1).forEach((h) => h.fn(ctx, delta));
  } else {
...
var runUseRenderCallbacks = (ctx, internalCtx, delta) => {
  ...
  if (anyHasOrder) {
    Array.from(internalCtx.renderHandlers).sort((a, b) => (a.order ?? 0) > (b.order ?? 0) ? 1 : -1).forEach((h) => h.fn(ctx, delta));
  } else {
...
var useFrameloop = (ctx, internalCtx) => {
  useRaf(() => {
    internalCtx.dispose();
...
function add_css(target) {
  append_styles(target, "svelte-o3oskp", "canvas.svelte-o3oskp{display:block}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64,eyJ2ZXJzaW9uIjozLCJmaWxlIjoiQ2FudmFzLnN2ZWx0ZSIsIm1hcHBpbmdzIjoiQUF3R0Usb0JBQU8sQ0FDTCxPQUFPLENBQUUsS0FDWCIsIm5hbWVzIjpbXSwic291cmNlcyI6WyJDYW52YXMuc3ZlbHRlIl19 */");
}
...
function create_fragment5(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      add_location(canvas_1, file, 95, 0, 2586);
    },
    m: function mount(target, anchor) {
...
//# sourceMappingURL=chunk-XDVD47K7.js.map
